...
namespace QuezalliApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(WarehouseDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(UserLoginModel loginModel)
        {
            ...
            // Devolver el token y el tipo de usuario en la respuesta
            return Ok(new { Message = "Inicio de sesión exitoso", Token = token, UserType = userType });
        }
